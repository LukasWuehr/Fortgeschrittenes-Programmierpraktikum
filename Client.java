...
class Client {
    boolean loggedIn;
    public Client(boolean loggedIn){this.loggedIn = loggedIn;}
    public static void main(String[] args) {
        ...
        try {
            ...
            while(!client.login(in, out)){System.out.println("LogIn");}
            Menu menu = new Menu();
    ...
    public boolean login(DataInputStream in, DataOutputStream out){
        ...
        try {
            ...
            } else if(intInput == 0){out.writeByte(0); loggedIn = false;}
